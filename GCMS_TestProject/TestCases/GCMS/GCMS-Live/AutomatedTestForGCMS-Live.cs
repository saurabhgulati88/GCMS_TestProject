...
{
    [TestClass]
    public class AutomatedTestForGCMS_Live 
    {
       ...
       [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "|DataDirectory|\\ForRSSFeedGCMS.csv", "ForRSSFeedGCMS#csv", DataAccessMethod.Sequential), DeploymentItem("GCMS_TestProject\\ForRSSFeedGCMS.csv"), DeploymentItem("Eclips\\ForRSSFeed.csv"), DeploymentItem("GCMS_TestProject\\ForRSSFeed.csv"), TestMethod]
        public void ForRSSFeedGCMS()
        {
            IWebDriver Driver = GCMS_TestProject.Library.TestEnvironment.Driver;
       ...
       public void ForSqlModuleGCMS()
       {
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "|DataDirectory|\\ExcelUploadGCMS.csv", "ExcelUploadGCMS#csv", DataAccessMethod.Sequential), DeploymentItem("GCMS_TestProject\\AppData\\ExcelUploadGCMS.csv"), TestMethod]
        public void ForExcelUploadGCMS()
        {
            IWebDriver Driver = TestEnvironment.Driver;
            string GCMS_admin_url = Record("Url");
            ...
            string SQLHeaderTemplateForDraft = Record("ExcelHeader Template For Draft");
